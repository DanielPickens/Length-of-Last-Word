  const lengthOfLastWord = function(s) {
    ...
    let count = 0;
    for (let i = s.length-1; i>=0; i--){  //for loop will traverse the array of s  and if element i on the array's indice correlates, it will find correlation enoguh to continue iteration, 
        if(s[i] === " " ){break;}
